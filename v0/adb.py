...
def checkUserInDatabase(username):
    ...
    c.execute(search)
    users = c.fetchall()
    print("THESE ARE THE USERS FROM CHECK USER IN DATABASE")
    print(users)
    for user in users:
        if (user[0] == username):
...
def hardCode():
    ...
    #
    # addEntryToDatabase ( 1 , 1, "Cat1", "Cats are cool.")
    # addEntryToDatabase ( 1 , 1, "Cat2", "Cats are so cool.")
    # addEntryToDatabase ( 1 , 1, "Cat3", "Cats are cool.")
    # addEntryToDatabase ( 1 , 1, "Cat4", "Cats are so cool.")
    # addEntryToDatabase ( 1 , 1, "Cat5", "Cats are cool.")
    # addEntryToDatabase ( 1 , 1, "Cat6", "Cats are so cool.")
...
#returns the blog title of the blogid
